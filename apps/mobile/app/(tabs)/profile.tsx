...
export default function ProfileScreen() {
  ...
  const totalStamps = orgs.reduce(
    (sum, o) =>
      sum +
      o.stamps.reduce((s, c) => s + (c.stamps % c.card.stamps_required), 0),
    0,
  );
    ...
    >
      <View style={styles.hero}>
        <Image
          ...
          resizeMode="cover"
        />
        <Text style={styles.heroTitle}>Anonymous explorer</Text>
        <Text style={styles.heroSubtitle}>
          You browse Nearby without an account. Your wallet is tied to this
          device.
        </Text>
      </View>
      ...
      <Card>
        ...
        <Text style={styles.cardBody}>
          Sign out and restart the onboarding flow to switch accounts or
          explore as a different user.
        </Text>
          ...
          <View style={{ gap: space(2) }}>
            ...
            <View style={styles.infoBadge}>
              ...
              <Text style={styles.infoBadgeText}>
                Build the Nearby dev client to enable
              </Text>
            </View>
          </View>
        ) : (
          <View style={{ gap: space(2) }}>
            <Text style={styles.cardBody}>
              {pushStatus === "registered"
                ? pushMsg
                : pushStatus === "error"
                  ? `Couldn't enable: ${pushMsg}`
                  : "Get a quiet ping when an offer drops within 8 km."}
            </Text>
            <Pressable
              style={[
                styles.btn,
                pushStatus === "registered" && styles.btnGreen,
              ]}
              onPress={enablePush}
      ...
      {showDebug && (
        <Card>
          ...
          <DebugRow
            label="Runtime"
            value={isExpoGo ? "Expo Go" : "Dev / standalone"}
          />
          <Pressable
          ...
          >
            <Text style={[styles.btnText, { color: colors.inkSoft }]}>
              Reset onboarding
            </Text>
          </Pressable>
        </Card>
...
function DebugRow({
  ...
  return (
    <View style={styles.debugRow}>
      ...
      <Text style={[styles.debugValue, mono && styles.mono]} numberOfLines={2}>
        {value}
      </Text>
    </View>
  );
